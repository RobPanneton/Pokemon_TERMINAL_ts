...
var introScreen_1 = require("./introScreen");
var mainMenu_1 = require("./mainMenu");
var teambuilderMainMenu_1 = require("./teambuilder/teambuilderMainMenu");
...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            return [4 /*yield*/, (0, introScreen_1.introScreen)()];
            case 1:
                // need async await for prompt to await
                _a.sent();
                while (true) {
                    mainMenuInput = (0, mainMenu_1.mainMenu)();
                    if (mainMenuInput === 1)
