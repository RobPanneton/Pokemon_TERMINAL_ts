...
var pascaleCase = function (string) { return __awaiter(void 0, void 0, void 0, function () {
...
var removeLeadingZeros = function (stringNum) {
    if (stringNum.charAt(0) !== "0")
        return stringNum;
    var cleanedNum = stringNum;
    while (cleanedNum.charAt(0) === "0")
        cleanedNum = cleanedNum.replace(/^0+/, "");
    return cleanedNum;
};
exports.removeLeadingZeros = removeLeadingZeros;
var addLeadingZeros = function (stringNum) {
    return stringNum.length < 3 ? (0, exports.addLeadingZeros)("0".concat(stringNum)) : stringNum;
};
exports.addLeadingZeros = addLeadingZeros;
var getSlotFromId = function (id) {
    return id.split("-")[0];
};
